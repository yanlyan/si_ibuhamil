...
?>
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="<?php echo $_smarty_tpl->tpl_vars['config']->value->site_url('master/rekapmedik/add_process');?>
...
"><?php echo $_smarty_tpl->tpl_vars['pasien']->value['pasien_nm'];?>
</option>
                                    <?php
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <textarea name="anamnese[s]" class="form-control" id="anamnese-s"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['anamnese_pxfisik']['s'])===null||$tmp==='' ? '' : $tmp);?>
</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <textarea name="anamnese[o]" class="form-control" id="anamnese-o"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['anamnese_pxfisik']['o'])===null||$tmp==='' ? '' : $tmp);?>
</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <textarea name="anamnese[a]" class="form-control" id="anamnese-a"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['anamnese_pxfisik']['a'])===null||$tmp==='' ? '' : $tmp);?>
</textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                ...
                                <textarea name="anamnese[p]" class="form-control" id="anamnese-p"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['result']->value['anamnese_pxfisik']['p'])===null||$tmp==='' ? '' : $tmp);?>
</textarea>
                            </div>
                        </div>
                        <div class="form-group">
