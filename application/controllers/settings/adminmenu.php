...
class adminmenu extends ApplicationBase {
    ...
    public function navigation($portal_id) {
        ...
        // load css
        $this->smarty->load_style("font-awesome/css/font-awesome.css");
        // get data portal
    ...
    public function add($portal_id) {
        ...
        $this->smarty->load_javascript("iconpicker/js/fontawesome-iconpicker.js");
        $this->smarty->load_javascript("jscolor/js/jscolor.js");
        // load css
        $this->smarty->load_style("font-awesome/css/font-awesome.css");
        $this->smarty->load_style("iconpicker/css/fontawesome-iconpicker.css");
        // get last parent id
    ...
    public function process_add() {
        ...
        $this->tnotification->set_rules('nav_icon_color', 'Warna', 'trim|max_length[6]');
        ...
        if ($this->tnotification->run() !== FALSE) {
            ...
            $this->input->post('active_st'), $this->input->post('display_st'), $this->input->post('nav_icon'), $this->input->post('nav_icon_color'), $this->com_user['user_id']);
            // insert
