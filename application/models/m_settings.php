...
class m_settings extends CI_Model {
    ...
    function insert_menu($params) {
        $sql = "INSERT INTO com_menu (portal_id, parent_id, nav_title, nav_desc, nav_url, nav_no, active_st, display_st, nav_icon, nav_icon_color, mdb, mdd)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())";
        return $this->db->query($sql, $params);
    }
    ...
    function update_menu($params) {
        $sql = "UPDATE com_menu
                SET portal_id = ?, parent_id = ?, nav_title = ?, nav_desc = ?, nav_url = ?, nav_no = ?, active_st = ?, display_st = ?, nav_icon = ?, nav_icon_color = ?, mdb = ?
                WHERE nav_id = ?";
        return $this->db->query($sql, $params);
    }
    ...
    function update_user_detail($params) {
        $sql = "UPDATE com_user SET operator_name = ?, operator_jabatan = ?, operator_phone = ?, mdb = ?, mdd = NOW()
                WHERE user_id = ?";
        return $this->db->query($sql, $params);
    }
