...
--
-- Host: localhost
-- Waktu pembuatan: 20. Januari 2016 jam 10:47
-- Versi Server: 5.5.16
-- Versi PHP: 5.3.8
...
--
-- Struktur dari tabel `anem_berat`
--
...
--
-- Dumping data untuk tabel `anem_berat`
--
...
--
-- Struktur dari tabel `anem_ringan`
--
...
--
-- Dumping data untuk tabel `anem_ringan`
--
...
--
-- Struktur dari tabel `anem_sedang`
--
...
--
-- Dumping data untuk tabel `anem_sedang`
--
...
--
-- Dumping data untuk tabel `home_tbl`
--
...
--
-- Struktur dari tabel `info_penyakit`
--
...
--
-- Dumping data untuk tabel `info_penyakit`
--
...
--
-- Dumping data untuk tabel `kebutuhan_gizi`
--
...
(4, 'I2004', 'Merasakan nyeri pinggang ?'),
(5, 'I2005', 'Terjadi mual dan muntah ?'),
(6, 'I2006', 'Konsentrasi hilang ?'),
(7, 'I2007', 'Nafas Pendek ?'),
(8, 'I2008', 'Rambut dan kuku terasa rapuh ?'),
(9, 'I2009', 'Terasa mengantuk ?'),
(10, 'I2010', 'Lidah terasa licin ?');
...
--
-- Ketidakleluasaan untuk tabel `anem_berat`
--
...
--
-- Ketidakleluasaan untuk tabel `anem_ringan`
--
...
--
-- Ketidakleluasaan untuk tabel `anem_sedang`
--
...
--
-- Ketidakleluasaan untuk tabel `hasil_konsul`
--
